    ...
    <div className="min-h-screen bg-[#0A0A0B] flex flex-col items-center justify-center p-6 ios-safe-area">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">5,000+ techniques analyzed.</p>
        ...
        {isIOS && (
          <>
            ...
            <button
                ...
                try {
                  ...
                  if (result.success && result.restored > 0) {
                    ...
                    toast({
                      ...
                      description: "Your subscription has been restored. Please sign in.",
                    });
              ...
              className="w-full text-gray-500 text-sm underline py-2"
        ...
        {authMode === 'login' ? (
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="text-center my-6 p-4 bg-zinc-900 rounded-lg">
              ...
              {/* Restore Purchases on subscription screen - Required by App Store Guideline 3.1.1 */}
              {isIOS && (
                <button
                  type="button"
                  onClick={async () => {
                  ...
                  className="text-zinc-500 text-xs underline mt-3"
                  data-testid="button-restore-purchases-register"
                >
                  Restore Purchases
                </button>
              )}
