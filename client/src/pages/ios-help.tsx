...
const faqs: FAQItem[] = [
  {
    ...
    answer: "Professor OS is your AI coach with perfect memory. It learns your game - your strengths, struggles, and goals. The more you share about your training, the smarter it gets. It draws from over 5,000 analyzed technique videos to give you personalized recommendations with exact timestamps."
  },
  {
